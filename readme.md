...
- Pre-built archive can be downloaded from the Release section (or here : https://github.com/Wayhlan/simpleTranscriber/releases/download/v100-alpha/simpleTranscriber_v100_alpha.rar)
